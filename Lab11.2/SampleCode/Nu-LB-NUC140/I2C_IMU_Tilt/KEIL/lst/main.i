...
int32_t main()
{
  ...
  y = 26;
	...
	draw_Bmp16x16(x, y, 0xFFFF, 0x0000, bmp_16x16);

  while(1) {		
    MPU6050_getAcceleration(ax, ay, az);

    pitch = atan(ax[0]/ sqrt(pow(ay[0],2)+pow(az[0],2))) * 180/3.14159265359;	
    roll  = atan(ay[0]/ sqrt(pow(ax[0],2)+pow(az[0],2))) * 180/3.14159265359;
