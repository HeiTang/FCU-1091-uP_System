#line 1 "..\\..\\..\\..\\Library\\Nu-LB-NUC140\\Source\\NVT_I2C.c"
...
#line 2 "..\\..\\..\\..\\Library\\Nu-LB-NUC140\\Source\\NVT_I2C.c"
...
#line 3 "..\\..\\..\\..\\Library\\Nu-LB-NUC140\\Source\\NVT_I2C.c"
...
#line 4 "..\\..\\..\\..\\Library\\Nu-LB-NUC140\\Source\\NVT_I2C.c"

#line 11 "..\\..\\..\\..\\Library\\Nu-LB-NUC140\\Source\\NVT_I2C.c"
...
uint8_t Tx_Data0[200];
uint8_t Rx_Data0[200];
uint8_t DataLen0;
uint8_t RxLen0;
uint8_t ContinueLen;
...
static volatile I2C_FUNC s_I2C1HandlerFn = 0;
...
void I2C_Callback_Rx(uint32_t status)
{
    if (status == 0x08)                      
    {
        I2C_SetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), Device_W_Addr<<1);
        I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 0);
    }   
    else if (status == 0x18)                 
    {
      I2C_SetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), Tx_Data0[DataLen0++]);
      I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 0);
    }
    else if (status == 0x20)                 
    {
      I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 1, 1, 0);
    }
    else if (status == 0x28)                 
    {
        if (DataLen0 != 2)
        ...
        {
          I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 1, 0, 1, 0);
          EndFlag0 = 1;
        }
    }
    else if (status == 0x10)                 
    {
      I2C_SetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), Device_W_Addr<<1 | 0x01);
      I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 0);
    }
    else if (status == 0x40)                 
    {
    ...
    {
      Rx_Data0[0] = I2C_GetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
      I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 1, 1, 0);
      EndFlag0 = 1;
    }
    else
...
void I2C_Callback_Rx_Continue(uint32_t status)
{
    if (status == 0x08)                      
    {
        I2C_SetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), Device_W_Addr<<1|ReadFlag);
        I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 0);
    }   
    else if (status == 0x18)                 
    {
    ...
    {
      if(ContinueLen>1)
        I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 1);
      else 
        I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 0);
    }       
    else if (status == 0x58)                 
    {
      Rx_Data0[RxLen0++] = I2C_GetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
      I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 1, 1, 0);
      EndFlag0 = 1;
    }
    else if (status == 0x50)                 
...
void I2C_Callback_Tx(uint32_t status)
{
    ...
    {
      I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 1, 1, 1, 0);
    }   
    else if (status == 0x28)                 
    {
        if (DataLen0 != 3)
...
void ResetPort() 
{
	I2C_Open(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 400000);
	I2C_EnableTimeout(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 1);
...
{
	if(timeout)
		I2C_EnableTimeout(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), (uint8_t) timeout);
	...
	I2C_DisableTimeout(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
}
...
void NVT_WriteByte(uint16_t address,uint8_t data)
{
	...
	while(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON & (1ul << 4));
	I2C_Ctrl(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 1, 0, 0, 0);
	WaitEndFlag0(0);
}
...
{
	I2C_Open(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), u32BusFreq);
	
	
	 
	I2C_EnableInt(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
	if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))==((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))) NVIC_EnableIRQ(I2C0_IRQn);	
	if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))==((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))) NVIC_EnableIRQ(I2C1_IRQn);
}
