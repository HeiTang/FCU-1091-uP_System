...
int32_t main(void)
{
    ...
    while (1)
    {
        while (1)
        {
            ...
            if (sum != 0)
                print_Line(lineNum, Text); // display string on LCD
        ...
        if (sum == sum_out)
        {
            sprintf(Text, "PASS"); // print scankey input to string
            printS(80, 16 * lineNum, Text);
        }
        else
        {
            sprintf(Text, "ERROR"); // print scankey input to string
            printS(80, 16 * lineNum, Text);
        }
        lineNum++;
        sum = 0;
