	...
	while(1) {
		...
		if (u32ADCvalue > 4000){
			...
			for (i = 0; i < 72; i++) {
				...
				PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000)), 0x0, music[i], 90); 
				if (music[i]!=0) PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000)), (1UL));
				else             PWM_DisableOutput(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000)), (1UL));
			...
			while(1){
				...
				if(u32ADCvalue > 4000 || u32ADCvalue < 500){
					...
					PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000)), 0x0,u32ADCvalue , 90);
					PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000)), (1UL));
