...
void Init_KEY(void)
{
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), (0x00000001 | 0x00000002 | 0x00000004), 0x3UL);
	  GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), (0x00000008 | 0x00000010 | 0x00000020), 0x3UL);
    ...
    (((GPIO_DBNCECON_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0180))->DBNCECON = ((1ul << 5) | (0x00000010UL) | (0x00000007UL)));
