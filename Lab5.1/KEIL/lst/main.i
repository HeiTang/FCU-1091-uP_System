...
int main(void)
{
  ...
  x= 50; y=16;	
	...
	draw_Bmp16x16(x,y,0xFFFF,0x0000,bmp1_16x16);
    ...
    switch(keyin){   
		...
		if(type == 0){
			...
			draw_Bmp16x16(x,y,0x0000,0x0000,bmp1_16x16); 
		}
		else if(type == 1){
			draw_Bmp16x16(x,y,0xFFFF,0x0000,bmp2_16x16); 
			CLK_SysTickDelay(100000);                      
			draw_Bmp16x16(x,y,0x0000,0x0000,bmp2_16x16); 
		}
		...
		if( x <= 1 && type == 0 ){
			dirX =+1;
			draw_Bmp16x16(x,y,0xFFFF,0x0000,bmp3_16x16); 
			CLK_SysTickDelay(1000000);                      
			draw_Bmp16x16(x,y,0x0000,0x0000,bmp3_16x16); 
		}
		if( x >= 112 && type == 0 ){
			dirX =-1;
			draw_Bmp16x16(x,y,0xFFFF,0x0000,bmp3_16x16); 
		...
		if( x <= -3 && type == 1 ){ 
				dirX =+1;
				draw_Bmp16x16(x,y,0xFFFF,0x0000,bmp4_16x16); 
				CLK_SysTickDelay(1000000);                      
				draw_Bmp16x16(x,y,0x0000,0x0000,bmp4_16x16); 
		}
		if( x >= 114 && type == 1 ){ 
			dirX =-1;
			draw_Bmp16x16(x,y,0xFFFF,0x0000,bmp4_16x16); 
