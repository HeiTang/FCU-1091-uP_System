    ...
    keyin = ScanKey(); 
		...
		if (keyin != 0 && FLAG == 0){
			...
			switch(keyin){   
				case 1:	
					if (N1 == 0 && WHO == 0){
						draw_Bmp16x16( x1 , y1 , 0xFFFF , 0x0000 , O_16x16);
						N1 = 1;
						WHO = 1;
					}
					else if (N1 == 0 && WHO == 1){
						draw_Bmp16x16( x1 , y1 , 0xFFFF , 0x0000 , X_16x16);
						N1 = 2;
						WHO = 0;
					}
					break;
				case 2: 
					if (N2 == 0 && WHO == 0){
						draw_Bmp16x16( x2 , y1 , 0xFFFF , 0x0000 , O_16x16);
						N2 = 1;
						WHO = 1;
					}
					else if (N2 == 0 && WHO == 1){
						draw_Bmp16x16( x2 , y1 , 0xFFFF , 0x0000 , X_16x16);
						N2 = 2;
						WHO = 0;
					}
					break;
				case 3:
					if (N3 == 0 && WHO == 0){
						draw_Bmp16x16( x3 , y1 , 0xFFFF , 0x0000 , O_16x16);
						N3 = 1;
						WHO = 1;
					}
					else if (N3 == 0 && WHO == 1){
						draw_Bmp16x16( x3 , y1 , 0xFFFF , 0x0000 , X_16x16);
						N3 = 2;
						WHO = 0;
					}
					break;
				case 4:	
					if (N4 == 0 && WHO == 0){
						draw_Bmp16x16( x1 , y2 , 0xFFFF , 0x0000 , O_16x16);
						N4 = 1;
						WHO = 1;
					}
					else if (N4 == 0 && WHO == 1){
						draw_Bmp16x16( x1 , y2 , 0xFFFF , 0x0000 , X_16x16);
						N4 = 2;
						WHO = 0;
					}
					break;
				case 5:
					if (N5 == 0 && WHO == 0){
						draw_Bmp16x16( x2 , y2 , 0xFFFF , 0x0000 , O_16x16);
						N5 = 1;
						WHO = 1;
					}
					else if (N5 == 0 && WHO == 1){
						draw_Bmp16x16( x2 , y2 , 0xFFFF , 0x0000 , X_16x16);
						N5 = 2;
						WHO = 0;
					}
					break;
				case 6: 
					if (N6 == 0 && WHO == 0){
						draw_Bmp16x16( x3 , y2 , 0xFFFF , 0x0000 , O_16x16);
						N6 = 1;
						WHO = 1;
					}
					else if (N6 == 0 && WHO == 1){
						draw_Bmp16x16( x3 , y2 , 0xFFFF , 0x0000 , X_16x16);
						N6 = 2;
						WHO = 0;
					}
					break;
				case 7:
					if (N7 == 0 && WHO == 0){
						draw_Bmp16x16( x1 , y3 , 0xFFFF , 0x0000 , O_16x16);
						N7 = 1;
						WHO = 1;
					}
					else if (N7 == 0 && WHO == 1){
						draw_Bmp16x16( x1 , y3 , 0xFFFF , 0x0000 , X_16x16);
						N7 = 2;
						WHO = 0;
					}
					break;
				case 8:
					if (N8 == 0 && WHO == 0){
						draw_Bmp16x16( x2 , y3 , 0xFFFF , 0x0000 , O_16x16);
						N8 = 1;
						WHO = 1;
					}
					else if (N8 == 0 && WHO == 1){
						draw_Bmp16x16( x2 , y3 , 0xFFFF , 0x0000 , X_16x16);
						N8 = 2;
						WHO = 0;
					}
					break;
				case 9:
					if (N9 == 0 && WHO == 0){
						draw_Bmp16x16( x3 , y3 , 0xFFFF , 0x0000 , O_16x16);
						N9 = 1;
						WHO = 1;
					}
					else if (N9 == 0 && WHO == 1){
						draw_Bmp16x16( x3 , y3 , 0xFFFF , 0x0000 , X_16x16);
						N9 = 2;
						WHO = 0;
					}
					break;			
